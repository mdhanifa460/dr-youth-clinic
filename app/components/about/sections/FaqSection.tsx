    ...
    <section className="bg-white py-14 md:py-20">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-10">
          <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#A25607] mb-2">Questions?</p>
        ...
        <div className="text-center mt-8">
          <Link href="/faqs" className="inline-flex items-center gap-2 text-sm font-bold text-[#0B2560] hover:text-[#2A6BA8] transition">
            View All FAQs →
          </Link>
        </div>
      </div>
