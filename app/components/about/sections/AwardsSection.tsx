    ...
    <section className="bg-white py-12 border-t border-gray-100">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-8">
          <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#A25607] mb-2">Recognised For Excellence</p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          {awards.map((a, i) => (
            <div key={i} className="flex-1 bg-[#f6faff] rounded-2xl p-6 ring-1 ring-[#e8eff7] flex flex-col items-center text-center">
              ...
              {a.year && <p className="text-[#A25607] font-headline font-extrabold text-sm mb-1">{a.year}</p>}
