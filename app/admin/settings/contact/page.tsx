        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden mb-6">
          <div className="px-6 py-4 border-b border-gray-50">
            ...
            <p className="text-gray-400 text-xs mt-0.5">
              Shown on the website Navbar, FAQ page, Clinical Intake, booking sidebar, and JSON-LD schema.
            </p>
          </div>
          <div className="px-6 py-5 space-y-5">
            ...
            <div>
              ...
              />
              <p className="text-[11px] text-gray-400 mt-1.5">
                Used for WhatsApp CTA links on the FAQ and Clinical Intake report pages. Digits only with country code, e.g. 919876543210.
              </p>
            </div>
