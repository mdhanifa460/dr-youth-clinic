...
const GROUPS = [
    ...
    items: [
      {
        ...
        desc: "Set your clinic tagline, brand colour, and social media links.",
        tags: ["Tagline", "Social links"],
      },
      {
      ...
      },
      {
        ...
        title: "Promotions",
        desc: "Set a live promo code with a discount percentage for the booking form.",
        tags: ["Promo code"],
      },
      {
      ...
      },
      {
        ...
        desc: "Visitor-interest tracking, scoring, thresholds, and per-section rules for a homepage that adapts to what each visitor is actually interested in. Tracking is off by default.",
        tags: ["Personalization", "Interest tracking", "Scoring engine"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/admin/settings/landing-page-form",
        icon: FileSliders,
        color: "bg-orange-50 text-orange-600",
        border: "border-orange-100 hover:border-orange-300",
        title: "Landing Page Form",
        desc: "Choose which section types must be present before a landing page can be published.",
        tags: ["Required sections", "Publish validation"],
      },
      {
