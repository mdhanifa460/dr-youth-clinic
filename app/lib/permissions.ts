...
export const ROLE_PERMISSIONS: Record<AdminRole, Record<AdminModule, AccessLevel>> = {
  super_admin: {
    dashboard: 'full', intelligence: 'full', bookings: 'full',
  ...
  marketing_manager: {
    dashboard: 'view', intelligence: 'full', bookings: 'view',
  ...
  doctor: {
    dashboard: 'view', intelligence: 'none', bookings: 'view',
  ...
  receptionist: {
    dashboard: 'view', intelligence: 'none', bookings: 'full',
    services: 'view', doctors: 'view', homepage: 'none',
  ...
  content_editor: {
    dashboard: 'view', intelligence: 'none', bookings: 'none',
    services: 'full', doctors: 'view', homepage: 'full',
